...
menu:
  leftnav:
    identifier: 7d6915e01c2e962c6b9eb44b100c72cc
    name: Syllabus
    weight: 10
title: Syllabus
type: course
uid: 7d6915e01c2e962c6b9eb44b100c72cc
...
See the [tools]({{< baseurl >}}/sections/tools) section for software and installation instructions.
...
The 6.001 project code is available in the [projects]({{< baseurl >}}/sections/projects) section. (Most of the problem sets will not require that you load pre-designed code, but the projects will generally build upon code that we provide for you.)
